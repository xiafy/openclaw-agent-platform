...
| 文档 | 路径 | 字数 | 用途 |
|------|------|------|------|
| `spec.md` (v8) | 项目主文档 | 更新 | 架构 + 状态 |
| `sop-l2-agent-deployment.md` | SOP v1.0 | 7.5K | 标准作业程序 |
| `retro-shuaishuai-l2.md` | 复盘报告 | 9K | 踩坑 + 经验 |
| `README-deployment.md` | 文档索引 | 3.5K | 导航 + 快速查找 |
| `QUICKSTART-L2.md` | 快速开始 | 3.6K | 9 步速查 |
| `life-agent-plan.md` | 原始计划 | 参考 | 历史对比 |
